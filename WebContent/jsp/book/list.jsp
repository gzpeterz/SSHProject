...
<BODY>
	<FORM id="customerForm" name="customerForm" action="${pageContext.request.contextPath }/book_findByPage.action" method=post>
											...
											<TBODY>
												...
												<c:forEach items="${page.beanList }" var="book">
													<TR
														...
														<TD>${book.state }</TD>
														<TD><a href="${pageContext.request.contextPath }/book_initUpdate.action?bid=${book.bid}">修改</a>
															&nbsp;&nbsp; 
															<a href="${pageContext.request.contextPath }/book_delete.action?bid=${book.bid}" onclick="return window.confirm('确认删除吗?')">删除</a>
														</TD>
													</TR>
												</c:forEach>
											</TBODY>
